...
class HXCPP_CLASS_ATTRIBUTES  Http_obj : public hx::Object{
	...
	public:
		...
		virtual ::haxe::Http addHeader( ::String header,::String value);
		Dynamic addHeader_dyn();

		virtual ::haxe::Http setParameter( ::String param,::String value);
		Dynamic setParameter_dyn();

		virtual ::haxe::Http addParameter( ::String param,::String value);
		...
		virtual Void fileTransfert( ::String argname,::String filename,::haxe::io::Input file,int size,::String mimeType);
