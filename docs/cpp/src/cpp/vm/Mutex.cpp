...
bool Mutex_obj::tryAcquire( ){
	HX_STACK_FRAME("cpp.vm.Mutex","tryAcquire",0x99512cd6,"cpp.vm.Mutex.tryAcquire","C:\\HaxeToolkit\\haxe\\std/cpp/vm/Mutex.hx",33,0x7b4ed3f2)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
	bool tmp = ::__hxcpp_mutex_try(this->m);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(34)
	return tmp;
}
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("tryAcquire","\xdb","\x77","\x4c","\x9c"),
