...
#include <cpp/link/StaticSqlite.h>
#endif
...
HX_STACK_FRAME("cpp.link.StaticSqlite","__init__",0x45f6cffb,"cpp.link.StaticSqlite.__init__","C:\\HaxeToolkit\\haxe\\std/cpp/link/StaticSqlite.hx",14,0x01f999f4)
{
	HX_STACK_LINE(14)
...
void StaticSqlite_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("cpp.link.StaticSqlite","\x23","\x6f","\x4e","\x9b");
