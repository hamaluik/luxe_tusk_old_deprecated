...
::Enum Type_obj::getEnum( Dynamic o){
	HX_STACK_FRAME("Type","getEnum",0x326d2523,"Type.getEnum","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",46,0x00143afe)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(47)
	bool tmp = (o == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(47)
	...
	HX_STACK_LINE(48)
	::Enum tmp1 = o->__GetClass();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(48)
	return tmp1;
}
...
::String Type_obj::enumConstructor( Dynamic e){
	HX_STACK_FRAME("Type","enumConstructor",0x45f8fde5,"Type.enumConstructor","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",132,0x00143afe)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(133)
	::String tmp = e->__Tag();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(133)
	return tmp;
}
...
int Type_obj::enumIndex( Dynamic e){
	HX_STACK_FRAME("Type","enumIndex",0xb61f99bd,"Type.enumIndex","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",141,0x00143afe)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(142)
	int tmp = e->__Index();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(142)
	return tmp;
}
...
cpp::ArrayBase Type_obj::allEnums( ::Enum e){
	HX_STACK_FRAME("Type","allEnums",0x86200985,"Type.allEnums","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",145,0x00143afe)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(146)
	Array< ::String > names = e->GetClassFields();		HX_STACK_VAR(names,"names");
	HX_STACK_LINE(147)
	cpp::ArrayBase enums = Dynamic( Array_obj<Dynamic>::__new() );		HX_STACK_VAR(enums,"enums");
	HX_STACK_LINE(148)
	{
		HX_STACK_LINE(148)
		...
		while((true)){
			HX_STACK_LINE(148)
			bool tmp = (_g < names->length);		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(148)
			bool tmp1 = !(tmp);		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(148)
			if ((tmp1)){
			...
			HX_STACK_LINE(148)
			::String tmp2 = names->__get(_g);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(148)
			...
			HX_STACK_CATCHABLE(::String, 0);
			{
				...
				HX_STACK_LINE(151)
				Dynamic tmp4 = e->ConstructEnum(tmp3,null());		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(151)
				...
				if ((tmp5)){
					...
					HX_STACK_LINE(153)
					enums->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp6);
				}
			}
			}
			catch(Dynamic __e){
