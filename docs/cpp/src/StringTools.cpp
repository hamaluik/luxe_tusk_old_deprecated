...
::String StringTools_obj::htmlUnescape( ::String s){
	HX_STACK_FRAME("StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","C:\\HaxeToolkit\\haxe\\std/StringTools.hx",116,0xb9dbeb2d)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(117)
	::String tmp = s.split(HX_HCSTRING("&gt;","\x08","\xa9","\x6c","\x19"))->join(HX_HCSTRING(">","\x3e","\x00","\x00","\x00"));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
	::String tmp1 = tmp.split(HX_HCSTRING("&lt;","\x4d","\x74","\x70","\x19"))->join(HX_HCSTRING("<","\x3c","\x00","\x00","\x00"));		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(117)
	::String tmp2 = tmp1.split(HX_HCSTRING("&quot;","\x2c","\xd9","\x81","\x8f"))->join(HX_HCSTRING("\"","\x22","\x00","\x00","\x00"));		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(117)
	::String tmp3 = tmp2.split(HX_HCSTRING("&#039;","\x62","\x26","\x77","\x78"))->join(HX_HCSTRING("'","\x27","\x00","\x00","\x00"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(117)
	::String tmp4 = tmp3.split(HX_HCSTRING("&amp;","\xdd","\xd4","\xaa","\x21"))->join(HX_HCSTRING("&","\x26","\x00","\x00","\x00"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(117)
	return tmp4;
}
...
int StringTools_obj::fastCodeAt( ::String s,int index){
	HX_STACK_FRAME("StringTools","fastCodeAt",0x6fd011c0,"StringTools.fastCodeAt","C:\\HaxeToolkit\\haxe\\std/StringTools.hx",376,0xb9dbeb2d)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isEof( int c){
	HX_STACK_FRAME("StringTools","isEof",0x69d30eee,"StringTools.isEof","C:\\HaxeToolkit\\haxe\\std/StringTools.hx",399,0xb9dbeb2d)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(401)
