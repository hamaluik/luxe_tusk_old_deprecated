...
::String Host_obj::reverse( ){
	HX_STACK_FRAME("sys.net.Host","reverse",0x015c156e,"sys.net.Host.reverse","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/net/Host.hx",37,0xf180fedc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
	int tmp = this->ip;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(38)
	::String tmp1 = ::sys::net::Host_obj::host_reverse(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(38)
	::String tmp2 = ::String(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(38)
	return tmp2;
...
bool Host_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"host_reverse") ) { outValue = host_reverse; return true;  }
		break;
	case 14:
...
bool Host_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"host_reverse") ) { host_reverse=ioValue.Cast< Dynamic >(); return true; }
		break;
	case 14:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(void *) &Host_obj::host_reverse,HX_HCSTRING("host_reverse","\x0b","\x0a","\xc1","\xe1")},
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("host_reverse","\x0b","\x0a","\xc1","\xe1"),
...
void Host_obj::__boot()
{
	...
	host_reverse= ::cpp::Lib_obj::load(HX_HCSTRING("std","\xa3","\xa8","\x57","\x00"),HX_HCSTRING("host_reverse","\x0b","\x0a","\xc1","\xe1"),(int)1);
