...
int Process_obj::getPid( ){
	HX_STACK_FRAME("sys.io.Process","getPid",0xcce2217b,"sys.io.Process.getPid","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",107,0x19dec630)
	HX_STACK_THIS(this)
	HX_STACK_LINE(108)
	Dynamic tmp = this->p;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(108)
	int tmp1 = ::sys::io::Process_obj::_pid(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(108)
	return tmp1;
}
...
int Process_obj::exitCode( ){
	HX_STACK_FRAME("sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",111,0x19dec630)
	HX_STACK_THIS(this)
	HX_STACK_LINE(112)
	Dynamic tmp = this->p;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(112)
...
{
		HX_STACK_FRAME("sys.io.Process","kill",0x814efa44,"sys.io.Process.kill","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",120,0x19dec630)
		HX_STACK_THIS(this)
		HX_STACK_LINE(120)
...
bool Process_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"_pid") ) { outValue = _pid; return true;  }
		break;
	case 5:
...
bool Process_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"_pid") ) { _pid=ioValue.Cast< Dynamic >(); return true; }
		break;
	case 5:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(void *) &Process_obj::_pid,HX_HCSTRING("_pid","\x4c","\x9d","\x20","\x3f")},
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("getPid","\x55","\x91","\x24","\xa3"),
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("_pid","\x4c","\x9d","\x20","\x3f"),
...
void Process_obj::__boot()
{
	...
	_pid= ::cpp::Lib_obj::load(HX_HCSTRING("std","\xa3","\xa8","\x57","\x00"),HX_HCSTRING("process_pid","\x3b","\xa3","\xde","\x70"),(int)1);
