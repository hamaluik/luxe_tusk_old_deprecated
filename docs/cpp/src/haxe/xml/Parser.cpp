...
bool Parser_obj::isValidChar( int c){
	HX_STACK_FRAME("haxe.xml.Parser","isValidChar",0x52d1e638,"haxe.xml.Parser.isValidChar","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",393,0xbc28dcd7)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(394)
	bool tmp = (c >= (int)97);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(394)
	...
	if ((tmp4)){
		HX_STACK_LINE(394)
		bool tmp6 = (c >= (int)65);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(394)
		bool tmp7 = tmp6;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(394)
		bool tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
	...
	if ((tmp7)){
		HX_STACK_LINE(394)
		bool tmp9 = (c >= (int)48);		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(394)
		bool tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(394)
		bool tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("isValidChar","\xa8","\xe4","\x15","\x0d"),
	::String(null()) };
