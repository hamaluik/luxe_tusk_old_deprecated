...
{
HX_STACK_FRAME("haxe.xml.Printer","new",0x896dce4d,"haxe.xml.Printer.new","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Printer.hx",42,0xc6da548c)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.xml.Printer","writeNode",0x6952ac2e,"haxe.xml.Printer.writeNode","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Printer.hx",48,0xc6da548c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.xml.Printer","write",0x5260800c,"haxe.xml.Printer.write","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Printer.hx",100,0xc6da548c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(input,"input")
		HX_STACK_LINE(101)
		::StringBuf tmp = this->output;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(101)
...
{
		HX_STACK_FRAME("haxe.xml.Printer","newline",0x6cfa90c1,"haxe.xml.Printer.newline","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Printer.hx",104,0xc6da548c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
		...
		if ((tmp)){
			...
			::StringBuf tmp1 = this->output;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(106)
			tmp1->add(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
		}
	}
return null();
}
...
bool Printer_obj::hasChildren( ::Xml value){
	HX_STACK_FRAME("haxe.xml.Printer","hasChildren",0xeb7e31a6,"haxe.xml.Printer.hasChildren","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Printer.hx",110,0xc6da548c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(111)
	...
	HX_STACK_ARG(pretty,"pretty")
{
		...
		HX_STACK_LINE(36)
		::String tmp2 = printer->output->b->join(HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(36)
		return tmp2;
	}
}
