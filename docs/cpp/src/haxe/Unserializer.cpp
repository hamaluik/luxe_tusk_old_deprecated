...
Dynamic Unserializer_obj::getResolver( ){
	HX_STACK_FRAME("haxe.Unserializer","getResolver",0x4ad7fd61,"haxe.Unserializer.getResolver","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",139,0x00b9ec83)
	HX_STACK_THIS(this)
	HX_STACK_LINE(140)
	Dynamic tmp = this->resolver;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(140)
	return tmp;
}
...
int Unserializer_obj::get( int p){
	HX_STACK_FRAME("haxe.Unserializer","get",0xa8f0923b,"haxe.Unserializer.get","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",143,0x00b9ec83)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_LINE(144)
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("getResolver","\xbc","\x3e","\xa4","\x32"),
