...
bool complement = __o_complement.Default(true);
	HX_STACK_FRAME("haxe.crypto.Base64","encode",0xc6961450,"haxe.crypto.Base64.encode","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Base64.hx",32,0x538071b1)
...
bool complement = __o_complement.Default(true);
	HX_STACK_FRAME("haxe.crypto.Base64","decode",0x319f7f68,"haxe.crypto.Base64.decode","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Base64.hx",45,0x538071b1)
...
struct _Function_0_1{
	inline static ::haxe::io::Bytes Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Base64.hx",30,0x538071b1)
		{
			HX_STACK_LINE(30)
