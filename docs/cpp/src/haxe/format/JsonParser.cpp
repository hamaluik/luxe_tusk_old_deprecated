...
Dynamic JsonParser_obj::parseNumber( int c){
	HX_STACK_FRAME("haxe.format.JsonParser","parseNumber",0x1cdbf9c4,"haxe.format.JsonParser.parseNumber","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",205,0x53425a8f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(206)
	int tmp = this->pos;		HX_STACK_VAR(tmp,"tmp");
	...
	HX_STACK_LINE(207)
	bool tmp2 = (c == (int)45);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(207)
	bool minus = tmp2;		HX_STACK_VAR(minus,"minus");
	HX_STACK_LINE(207)
	bool tmp3 = minus;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(207)
	bool tmp4 = !(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(207)
	bool digit = tmp4;		HX_STACK_VAR(digit,"digit");
	HX_STACK_LINE(207)
	bool tmp5 = (c == (int)48);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(207)
	bool zero = tmp5;		HX_STACK_VAR(zero,"zero");
	HX_STACK_LINE(208)
	bool point = false;		HX_STACK_VAR(point,"point");
	HX_STACK_LINE(208)
	bool e = false;		HX_STACK_VAR(e,"e");
	...
	while((true)){
		...
		switch( (int)(tmp7)){
			case (int)48: {
				HX_STACK_LINE(213)
				bool tmp8 = zero;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(213)
				bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(213)
				if ((tmp8)){
					HX_STACK_LINE(213)
					bool tmp10 = point;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(213)
					bool tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(213)
					tmp9 = !(tmp11);
				...
				if ((tmp9)){
					...
					int tmp10 = start;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(213)
					this->invalidNumber(tmp10);
				}
				HX_STACK_LINE(214)
				bool tmp10 = minus;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(214)
				if ((tmp10)){
					HX_STACK_LINE(215)
					minus = false;
			...
			case (int)46: {
				HX_STACK_LINE(223)
				bool tmp8 = minus;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(223)
				bool tmp9 = !(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(223)
				bool tmp10;		HX_STACK_VAR(tmp10,"tmp10");
			...
			case (int)43: case (int)45: {
				HX_STACK_LINE(229)
				bool tmp8 = e;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(229)
				bool tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(229)
				bool tmp10 = !(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
			...
			default: {
				HX_STACK_LINE(232)
				bool tmp8 = digit;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(232)
				bool tmp9 = !(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(232)
				if ((tmp9)){
		...
		HX_STACK_LINE(236)
		bool tmp8 = end;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(236)
		if ((tmp8)){
			HX_STACK_LINE(236)
			break;
	...
	HX_STACK_LINE(238)
	::String tmp11 = tmp6.substr(tmp7,tmp10);		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(238)
	Float tmp12 = ::Std_obj::parseFloat(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(238)
	Float f = tmp12;		HX_STACK_VAR(f,"f");
	HX_STACK_LINE(239)
	Float tmp13 = f;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(239)
	int tmp14 = ::Std_obj::_int(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(239)
	int i = tmp14;		HX_STACK_VAR(i,"i");
	HX_STACK_LINE(240)
	bool tmp15 = (i == f);		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(240)
...
int JsonParser_obj::nextChar( ){
	HX_STACK_FRAME("haxe.format.JsonParser","nextChar",0xf138ae01,"haxe.format.JsonParser.nextChar","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",243,0x53425a8f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(244)
	int tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(244)
...
Dynamic JsonParser_obj::parse( ::String str){
	HX_STACK_FRAME("haxe.format.JsonParser","parse",0xed2c189b,"haxe.format.JsonParser.parse","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonParser.hx",42,0x53425a8f)
	HX_STACK_ARG(str,"str")
	HX_STACK_LINE(43)
	::haxe::format::JsonParser tmp = ::haxe::format::JsonParser_obj::__new(str);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(43)
...
Dynamic JsonParser_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"parseNumber") ) { return parseNumber_dyn(); }
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("parseNumber","\x5c","\x33","\xb7","\x1c"),
