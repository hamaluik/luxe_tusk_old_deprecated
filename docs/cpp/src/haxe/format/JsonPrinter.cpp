...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","ipad",0x0d13fcd5,"haxe.format.JsonPrinter.ipad","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",69,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		bool tmp = this->pretty;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(70)
		if ((tmp)){
			HX_STACK_LINE(70)
			::String tmp1 = this->indent;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(70)
			int tmp2 = this->nind;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(70)
			::String tmp3 = this->indent;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(70)
			int tmp4 = tmp3.length;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(70)
			int tmp5 = (tmp2 * tmp4);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(70)
			::String tmp6 = ::StringTools_obj::lpad(HX_HCSTRING("","\x00","\x00","\x00","\x00"),tmp1,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(70)
...
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","newl",0x1059c857,"haxe.format.JsonPrinter.newl","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",73,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_LINE(74)
		bool tmp = this->pretty;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(74)
...
Void JsonPrinter_obj::addChar( int c){
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","addChar",0xcb1ade2c,"haxe.format.JsonPrinter.addChar","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",138,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(142)
		{
			HX_STACK_LINE(142)
			this->buf->b->push(::String::fromCharCode(c));
		}
	}
return null();
}
...
HX_DEFINE_DYNAMIC_FUNC1(JsonPrinter_obj,addChar,(void))

Void JsonPrinter_obj::add( ::String v){
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","add",0xeb5f0036,"haxe.format.JsonPrinter.add","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",146,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(151)
		this->buf->add(v);
...
HX_DEFINE_DYNAMIC_FUNC1(JsonPrinter_obj,add,(void))

Void JsonPrinter_obj::objString( Dynamic v){
{
		HX_STACK_FRAME("haxe.format.JsonPrinter","objString",0x583a4bfd,"haxe.format.JsonPrinter.objString","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",161,0x660ed7d4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(162)
		...
		HX_STACK_LINE(162)
		this->fieldsString(tmp,::Reflect_obj::fields(tmp1));
	}
return null();
}
...
Dynamic JsonPrinter_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"ipad") ) { return ipad_dyn(); }
		if (HX_FIELD_EQ(inName,"newl") ) { return newl_dyn(); }
		break;
	case 5:
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("ipad","\x8a","\xb8","\xbc","\x45"),
	HX_HCSTRING("newl","\x0c","\x84","\x02","\x49"),
	HX_HCSTRING("write","\xdf","\x6c","\x59","\xd0"),
	HX_HCSTRING("addChar","\x97","\xa1","\xfc","\x7d"),
	HX_HCSTRING("add","\x21","\xf2","\x49","\x00"),
	HX_HCSTRING("objString","\x28","\x00","\xa4","\xd9"),
