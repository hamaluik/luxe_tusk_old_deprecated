...
::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::_new( int elements){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","_new",0xb877cb3c,"haxe.io._UInt32Array.UInt32Array_Impl_._new","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",32,0xacca0917)
	...
	HX_STACK_LINE(33)
	{
		...
		{
			HX_STACK_LINE(33)
			int tmp2 = (elements * (int)4);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(33)
...
int UInt32Array_Impl__obj::get_length( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","get_length",0xdaba10ca,"haxe.io._UInt32Array.UInt32Array_Impl_.get_length","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",36,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(37)
	int tmp = (int(this1->byteLength) >> int((int)2));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(37)
	return tmp;
}
...
::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::get_view( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","get_view",0x73222d49,"haxe.io._UInt32Array.UInt32Array_Impl_.get_view","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",40,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(41)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt32Array_Impl__obj,get_view,return )

int UInt32Array_Impl__obj::get( ::haxe::io::ArrayBufferViewImpl this1,int index){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","get",0x70347f1b,"haxe.io._UInt32Array.UInt32Array_Impl_.get","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",44,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	...
	HX_STACK_LINE(45)
	{
		...
		HX_STACK_LINE(45)
		int tmp1 = (int(index) << int((int)2));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(45)
		...
		HX_STACK_LINE(45)
		int tmp4 = _this->b->__get(pos);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(45)
		int tmp5 = (pos + (int)1);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(45)
		int tmp6 = _this->b->__get(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(45)
		...
		HX_STACK_LINE(45)
		int tmp10 = _this->b->__get(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(45)
		...
		HX_STACK_LINE(45)
		int tmp14 = _this->b->__get(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(45)
		int tmp15 = (int(tmp14) << int((int)24));		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(45)
		tmp = (int(tmp12) | int(tmp15));
	}
	HX_STACK_LINE(45)
	return tmp;
}
...
int UInt32Array_Impl__obj::set( ::haxe::io::ArrayBufferViewImpl this1,int index,int value){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","set",0x703d9a27,"haxe.io._UInt32Array.UInt32Array_Impl_.set","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",48,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	...
	if ((tmp1)){
		HX_STACK_LINE(50)
		{
			...
			::haxe::io::Bytes _this = this1->bytes;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(50)
			int tmp2 = (int(index) << int((int)2));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(50)
			...
			HX_STACK_LINE(50)
			{
				...
				int tmp5 = (pos + (int)1);		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(50)
				int tmp6 = (int(value) >> int((int)8));		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(50)
				_this->b[tmp5] = tmp6;
			}
			HX_STACK_LINE(50)
			{
				...
				HX_STACK_LINE(50)
				int tmp6 = (int(value) >> int((int)16));		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(50)
				_this->b[tmp5] = tmp6;
			}
			HX_STACK_LINE(50)
			{
				HX_STACK_LINE(50)
				int tmp5 = (pos + (int)3);		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(50)
				int tmp6 = hx::UShr(value,(int)24);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(50)
				_this->b[tmp5] = tmp6;
			}
		}
...
::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::sub( ::haxe::io::ArrayBufferViewImpl this1,int begin,Dynamic length){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","sub",0x703da805,"haxe.io._UInt32Array.UInt32Array_Impl_.sub","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",56,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(57)
	int tmp = (int(begin) << int((int)2));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(57)
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(57)
		tmp2 = (int(length) << int((int)2));
	}
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp3 = this1->sub(tmp,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp4 = ::haxe::io::_UInt32Array::UInt32Array_Impl__obj::fromData(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(57)
	return tmp4;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt32Array_Impl__obj,sub,return )

::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::subarray( ::haxe::io::ArrayBufferViewImpl this1,Dynamic begin,Dynamic end){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","subarray",0xac999374,"haxe.io._UInt32Array.UInt32Array_Impl_.subarray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",60,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(61)
		tmp3 = (int(end) << int((int)2));
	}
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp4 = this1->subarray(tmp1,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp5 = ::haxe::io::_UInt32Array::UInt32Array_Impl__obj::fromData(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(61)
	return tmp5;
}
...
::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::getData( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","getData",0x36ee2ae5,"haxe.io._UInt32Array.UInt32Array_Impl_.getData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",64,0xacca0917)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(65)
	::haxe::io::ArrayBufferViewImpl tmp = this1;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(65)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt32Array_Impl__obj,getData,return )

::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::fromData( ::haxe::io::ArrayBufferViewImpl d){
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","fromData",0x4547640f,"haxe.io._UInt32Array.UInt32Array_Impl_.fromData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",68,0xacca0917)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(69)
...
::haxe::io::ArrayBufferViewImpl UInt32Array_Impl__obj::fromArray( Array< int > a,hx::Null< int >  __o_pos,Dynamic length){
int pos = __o_pos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","fromArray",0xaa378814,"haxe.io._UInt32Array.UInt32Array_Impl_.fromArray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",72,0xacca0917)
	HX_STACK_ARG(a,"a")
	...
	HX_STACK_ARG(length,"length")
{
		...
		HX_STACK_LINE(75)
		{
			...
			HX_STACK_LINE(75)
			{
				...
				{
					HX_STACK_LINE(75)
					int tmp10 = (a->length * (int)4);		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(75)
		...
		HX_STACK_LINE(76)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(77)
				int tmp12 = a->__get(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(77)
				...
				if ((tmp14)){
					HX_STACK_LINE(77)
					{
						...
						HX_STACK_LINE(77)
						int tmp16 = (int(idx) << int((int)2));		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(77)
						int tmp17 = i->byteOffset;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(77)
						int tmp18 = (tmp16 + tmp17);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(77)
						int pos1 = tmp18;		HX_STACK_VAR(pos1,"pos1");
						HX_STACK_LINE(77)
						{
							HX_STACK_LINE(77)
							int tmp19 = value;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(77)
							_this->b[pos1] = tmp19;
						}
						HX_STACK_LINE(77)
						{
							HX_STACK_LINE(77)
							int tmp19 = (pos1 + (int)1);		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(77)
							int tmp20 = (int(value) >> int((int)8));		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(77)
							_this->b[tmp19] = tmp20;
						}
						HX_STACK_LINE(77)
						{
							HX_STACK_LINE(77)
							int tmp19 = (pos1 + (int)2);		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(77)
							int tmp20 = (int(value) >> int((int)16));		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(77)
							_this->b[tmp19] = tmp20;
						}
						HX_STACK_LINE(77)
						{
							HX_STACK_LINE(77)
							int tmp19 = (pos1 + (int)3);		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(77)
							int tmp20 = hx::UShr(value,(int)24);		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(77)
							_this->b[tmp19] = tmp20;
						}
					}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt32Array_Impl__obj,fromArray,return )
...
int bytePos = __o_bytePos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt32Array.UInt32Array_Impl_","fromBytes",0x424022e6,"haxe.io._UInt32Array.UInt32Array_Impl_.fromBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt32Array.hx",81,0xacca0917)
