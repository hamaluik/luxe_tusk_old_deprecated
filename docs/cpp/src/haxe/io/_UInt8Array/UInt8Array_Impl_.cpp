...
::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::_new( int elements){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","_new",0x33bf2c40,"haxe.io._UInt8Array.UInt8Array_Impl_._new","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",32,0x7b7c33ea)
	...
	HX_STACK_LINE(33)
	{
		...
		HX_STACK_LINE(33)
		{
			...
			HX_STACK_LINE(33)
			int tmp2 = elements;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(33)
			::haxe::io::Bytes tmp3 = ::haxe::io::Bytes_obj::alloc(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(33)
			int tmp4 = elements;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(33)
			::haxe::io::ArrayBufferViewImpl tmp5 = ::haxe::io::ArrayBufferViewImpl_obj::__new(tmp3,(int)0,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(33)
			this2 = tmp5;
			HX_STACK_LINE(33)
			tmp1 = this2;
...
int UInt8Array_Impl__obj::get_length( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","get_length",0xcd960cce,"haxe.io._UInt8Array.UInt8Array_Impl_.get_length","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",36,0x7b7c33ea)
...
::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::get_view( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","get_view",0xc9c8604d,"haxe.io._UInt8Array.UInt8Array_Impl_.get_view","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",40,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(41)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt8Array_Impl__obj,get_view,return )

int UInt8Array_Impl__obj::get( ::haxe::io::ArrayBufferViewImpl this1,int index){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","get",0x51c32a97,"haxe.io._UInt8Array.UInt8Array_Impl_.get","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",44,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(45)
	int tmp = (index + this1->byteOffset);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(45)
	int tmp1 = this1->bytes->b->__get(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(45)
	return tmp1;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC2(UInt8Array_Impl__obj,get,return )

int UInt8Array_Impl__obj::set( ::haxe::io::ArrayBufferViewImpl this1,int index,int value){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","set",0x51cc45a3,"haxe.io._UInt8Array.UInt8Array_Impl_.set","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",48,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	...
	if ((tmp1)){
		...
		{
			HX_STACK_LINE(50)
			int tmp2 = (index + this1->byteOffset);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(50)
			int tmp3 = value;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(50)
			this1->bytes->b[tmp2] = tmp3;
		}
		HX_STACK_LINE(51)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt8Array_Impl__obj,set,return )

::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::sub( ::haxe::io::ArrayBufferViewImpl this1,int begin,Dynamic length){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","sub",0x51cc5381,"haxe.io._UInt8Array.UInt8Array_Impl_.sub","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",56,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(57)
	int tmp = begin;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(57)
	Dynamic tmp1 = length;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp2 = this1->sub(tmp,tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp3 = ::haxe::io::_UInt8Array::UInt8Array_Impl__obj::fromData(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(57)
	return tmp3;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt8Array_Impl__obj,sub,return )

::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::subarray( ::haxe::io::ArrayBufferViewImpl this1,Dynamic begin,Dynamic end){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","subarray",0x033fc678,"haxe.io._UInt8Array.UInt8Array_Impl_.subarray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",60,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	HX_STACK_ARG(end,"end")
	HX_STACK_LINE(61)
	Dynamic tmp = begin;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(61)
	Dynamic tmp1 = end;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp2 = this1->subarray(tmp,tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp3 = ::haxe::io::_UInt8Array::UInt8Array_Impl__obj::fromData(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(61)
	return tmp3;
...
::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::getData( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","getData",0xe25e4461,"haxe.io._UInt8Array.UInt8Array_Impl_.getData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",64,0x7b7c33ea)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(65)
	::haxe::io::ArrayBufferViewImpl tmp = this1;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(65)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt8Array_Impl__obj,getData,return )

::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::fromData( ::haxe::io::ArrayBufferViewImpl d){
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","fromData",0x9bed9713,"haxe.io._UInt8Array.UInt8Array_Impl_.fromData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",68,0x7b7c33ea)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(69)
...
::haxe::io::ArrayBufferViewImpl UInt8Array_Impl__obj::fromArray( Array< int > a,hx::Null< int >  __o_pos,Dynamic length){
int pos = __o_pos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","fromArray",0x24fdf890,"haxe.io._UInt8Array.UInt8Array_Impl_.fromArray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",72,0x7b7c33ea)
	HX_STACK_ARG(a,"a")
	...
	HX_STACK_ARG(length,"length")
{
		...
		{
			HX_STACK_LINE(75)
			int elements = a->length;		HX_STACK_VAR(elements,"elements");
			HX_STACK_LINE(75)
			::haxe::io::ArrayBufferViewImpl this1;		HX_STACK_VAR(this1,"this1");
			HX_STACK_LINE(75)
			...
			HX_STACK_LINE(75)
			{
				...
				HX_STACK_LINE(75)
				{
					...
					::haxe::io::ArrayBufferViewImpl this2;		HX_STACK_VAR(this2,"this2");
					HX_STACK_LINE(75)
					int tmp10 = elements;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(75)
					::haxe::io::Bytes tmp11 = ::haxe::io::Bytes_obj::alloc(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(75)
					int tmp12 = elements;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(75)
					::haxe::io::ArrayBufferViewImpl tmp13 = ::haxe::io::ArrayBufferViewImpl_obj::__new(tmp11,(int)0,tmp12);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(75)
					this2 = tmp13;
					HX_STACK_LINE(75)
					tmp9 = this2;
			...
			while((true)){
				...
				if ((tmp14)){
					HX_STACK_LINE(77)
					{
						...
						HX_STACK_LINE(77)
						int tmp16 = idx;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(77)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt8Array_Impl__obj,fromArray,return )
...
int bytePos = __o_bytePos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt8Array.UInt8Array_Impl_","fromBytes",0xbd069362,"haxe.io._UInt8Array.UInt8Array_Impl_.fromBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt8Array.hx",81,0x7b7c33ea)
	...
	HX_STACK_ARG(length,"length")
{
		...
		HX_STACK_LINE(82)
		{
			...
			HX_STACK_LINE(82)
			::haxe::io::ArrayBufferViewImpl tmp4 = ::haxe::io::_ArrayBufferView::ArrayBufferView_Impl__obj::fromBytes(tmp1,tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(82)
		...
		HX_STACK_LINE(82)
		::haxe::io::ArrayBufferViewImpl tmp1 = ::haxe::io::_UInt8Array::UInt8Array_Impl__obj::fromData(tmp);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(82)
		return tmp1;
	}
}
...
void UInt8Array_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("haxe.io._UInt8Array.UInt8Array_Impl_","\xef","\xb5","\xc9","\x76");
