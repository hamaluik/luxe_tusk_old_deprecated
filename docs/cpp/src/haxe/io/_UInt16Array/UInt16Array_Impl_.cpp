...
::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::_new( int elements){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","_new",0x3b9ff0c8,"haxe.io._UInt16Array.UInt16Array_Impl_._new","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",32,0x77fabd5d)
	...
	HX_STACK_LINE(33)
	{
		...
		{
			HX_STACK_LINE(33)
			int tmp2 = (elements * (int)2);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(33)
...
int UInt16Array_Impl__obj::get_length( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","get_length",0x83c8e756,"haxe.io._UInt16Array.UInt16Array_Impl_.get_length","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",36,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(37)
	int tmp = (int(this1->byteLength) >> int((int)1));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(37)
	return tmp;
}
...
::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::get_view( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","get_view",0x19da08d5,"haxe.io._UInt16Array.UInt16Array_Impl_.get_view","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",40,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(41)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt16Array_Impl__obj,get_view,return )

int UInt16Array_Impl__obj::get( ::haxe::io::ArrayBufferViewImpl this1,int index){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","get",0x3d224f0f,"haxe.io._UInt16Array.UInt16Array_Impl_.get","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",44,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	...
	HX_STACK_LINE(45)
	{
		...
		HX_STACK_LINE(45)
		int tmp1 = (int(index) << int((int)1));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(45)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(UInt16Array_Impl__obj,get,return )

int UInt16Array_Impl__obj::set( ::haxe::io::ArrayBufferViewImpl this1,int index,int value){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","set",0x3d2b6a1b,"haxe.io._UInt16Array.UInt16Array_Impl_.set","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",48,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
	...
	if ((tmp1)){
		HX_STACK_LINE(50)
		{
			...
			::haxe::io::Bytes _this = this1->bytes;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(50)
			int tmp2 = (int(index) << int((int)1));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(50)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,set,return )

::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::sub( ::haxe::io::ArrayBufferViewImpl this1,int begin,Dynamic length){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","sub",0x3d2b77f9,"haxe.io._UInt16Array.UInt16Array_Impl_.sub","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",56,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(57)
	int tmp = (int(begin) << int((int)1));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(57)
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(57)
		tmp2 = (int(length) << int((int)1));
	}
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp3 = this1->sub(tmp,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(57)
	::haxe::io::ArrayBufferViewImpl tmp4 = ::haxe::io::_UInt16Array::UInt16Array_Impl__obj::fromData(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(57)
	return tmp4;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,sub,return )

::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::subarray( ::haxe::io::ArrayBufferViewImpl this1,Dynamic begin,Dynamic end){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","subarray",0x53516f00,"haxe.io._UInt16Array.UInt16Array_Impl_.subarray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",60,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(begin,"begin")
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(61)
		tmp3 = (int(end) << int((int)1));
	}
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp4 = this1->subarray(tmp1,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(61)
	::haxe::io::ArrayBufferViewImpl tmp5 = ::haxe::io::_UInt16Array::UInt16Array_Impl__obj::fromData(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(61)
	return tmp5;
}
...
::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::getData( ::haxe::io::ArrayBufferViewImpl this1){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","getData",0xee3504d9,"haxe.io._UInt16Array.UInt16Array_Impl_.getData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",64,0x77fabd5d)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(65)
	::haxe::io::ArrayBufferViewImpl tmp = this1;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(65)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt16Array_Impl__obj,getData,return )

::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::fromData( ::haxe::io::ArrayBufferViewImpl d){
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","fromData",0xebff3f9b,"haxe.io._UInt16Array.UInt16Array_Impl_.fromData","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",68,0x77fabd5d)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(69)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt16Array_Impl__obj,fromData,return )

::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::fromArray( Array< int > a,hx::Null< int >  __o_pos,Dynamic length){
int pos = __o_pos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","fromArray",0xe45fc708,"haxe.io._UInt16Array.UInt16Array_Impl_.fromArray","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",72,0x77fabd5d)
	HX_STACK_ARG(a,"a")
	...
	HX_STACK_ARG(length,"length")
{
		...
		HX_STACK_LINE(75)
		{
			...
			HX_STACK_LINE(75)
			{
				...
				{
					HX_STACK_LINE(75)
					int tmp10 = (a->length * (int)2);		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(75)
			...
			while((true)){
				...
				if ((tmp14)){
					HX_STACK_LINE(77)
					{
						...
						HX_STACK_LINE(77)
						int tmp16 = (int(idx) << int((int)1));		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(77)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,fromArray,return )

::haxe::io::ArrayBufferViewImpl UInt16Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes,hx::Null< int >  __o_bytePos,Dynamic length){
int bytePos = __o_bytePos.Default(0);
	HX_STACK_FRAME("haxe.io._UInt16Array.UInt16Array_Impl_","fromBytes",0x7c6861da,"haxe.io._UInt16Array.UInt16Array_Impl_.fromBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/UInt16Array.hx",81,0x77fabd5d)
	...
	HX_STACK_ARG(length,"length")
{
		...
		HX_STACK_LINE(82)
		::haxe::io::ArrayBufferViewImpl tmp1 = ::haxe::io::_UInt16Array::UInt16Array_Impl__obj::fromData(tmp);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(82)
		return tmp1;
	}
}
...
void UInt16Array_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("haxe.io._UInt16Array.UInt16Array_Impl_","\x67","\x3e","\xaf","\x74");
