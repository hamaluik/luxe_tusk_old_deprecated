...
{
HX_STACK_FRAME("haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",35,0xe8d8730b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(40)
...
int BytesOutput_obj::get_length( ){
	HX_STACK_FRAME("haxe.io.BytesOutput","get_length",0xc7c55971,"haxe.io.BytesOutput.get_length","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",47,0xe8d8730b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
	::haxe::io::BytesBuffer tmp = this->b;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(48)
	int tmp1 = tmp->b->length;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(48)
	return tmp1;
}
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesOutput.hx",125,0xe8d8730b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(131)
	::haxe::io::BytesBuffer tmp = this->b;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(131)
