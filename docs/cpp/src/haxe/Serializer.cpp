...
Dynamic Serializer_obj::__getField( Dynamic o,::String f){
	HX_STACK_FRAME("haxe.Serializer","__getField",0xb4ce6958,"haxe.Serializer.__getField","C:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",519,0xfce2327c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(519)
	return o->__GetItem(f);
}


HX_DEFINE_DYNAMIC_FUNC2(Serializer_obj,__getField,return )

Void Serializer_obj::serializeException( Dynamic e){
{
		HX_STACK_FRAME("haxe.Serializer","serializeException",0xdb6c3c43,"haxe.Serializer.serializeException","C:\\HaxeToolkit\\haxe\\std/haxe/Serializer.hx",521,0xfce2327c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(522)
		::StringBuf tmp = this->buf;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(522)
		tmp->add(HX_HCSTRING("x","\x78","\x00","\x00","\x00"));
		HX_STACK_LINE(534)
...
Dynamic Serializer_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__getField") ) { return __getField_dyn(); }
		break;
	case 12:
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("__getField","\x64","\x17","\xa3","\x03"),
	HX_HCSTRING("serializeException","\x4f","\xd6","\xef","\x16"),
	::String(null()) };
