...
::String StringMap_obj::toString( ){
	HX_STACK_FRAME("haxe.ds.StringMap","toString",0xe5a17e86,"haxe.ds.StringMap.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/StringMap.hx",80,0x969b5cf0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	::String tmp = ::__string_hash_to_string(this->h);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(81)
	return tmp;
}
