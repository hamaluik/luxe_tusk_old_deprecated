...
bool BalancedTree_obj::remove( Dynamic key){
	...
	HX_STACK_CATCHABLE(::String, 0);
	{
		...
		HX_STACK_LINE(84)
		::haxe::ds::TreeNode tmp2 = this->removeLoop(tmp,tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(84)
		this->root = tmp2;
		HX_STACK_LINE(85)
		return true;
...
Dynamic BalancedTree_obj::iterator( ){
	...
	::haxe::ds::TreeNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
	this->iteratorLoop(tmp,ret);
	HX_STACK_LINE(118)
	Dynamic tmp1 = ret->__Field(HX_HCSTRING("iterator","\xee","\x49","\x9a","\x93"), hx::paccDynamic )();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(118)
	return tmp1;
}
...
::haxe::ds::TreeNode BalancedTree_obj::removeLoop( Dynamic k,::haxe::ds::TreeNode node){
	...
	if ((tmp)){
		HX_STACK_LINE(146)
		HX_STACK_DO_THROW(HX_HCSTRING("Not_found","\xb6","\x92","\xa5","\xea"));
	}
	HX_STACK_LINE(147)
	Dynamic tmp1 = k;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(147)
	...
	if ((tmp4)){
		...
		::haxe::ds::TreeNode tmp6 = node->left;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(148)
		::haxe::ds::TreeNode tmp7 = node->right;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(148)
		tmp5 = this->merge(tmp6,tmp7);
	}
	else{
		HX_STACK_LINE(149)
		bool tmp6 = (c < (int)0);		HX_STACK_VAR(tmp6,"tmp6");
		...
		if ((tmp6)){
			...
			Dynamic tmp7 = k;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(149)
			::haxe::ds::TreeNode tmp8 = node->left;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(149)
			::haxe::ds::TreeNode tmp9 = this->removeLoop(tmp7,tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(149)
			Dynamic tmp10 = node->key;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(149)
			Dynamic tmp11 = node->value;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(149)
			::haxe::ds::TreeNode tmp12 = node->right;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(149)
			tmp5 = this->balance(tmp9,tmp10,tmp11,tmp12);
		}
		else{
			HX_STACK_LINE(150)
			::haxe::ds::TreeNode tmp7 = node->left;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(150)
			Dynamic tmp8 = node->key;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(150)
			Dynamic tmp9 = node->value;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(150)
			Dynamic tmp10 = k;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(150)
			::haxe::ds::TreeNode tmp11 = node->right;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(150)
			::haxe::ds::TreeNode tmp12 = this->removeLoop(tmp10,tmp11);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(150)
			tmp5 = this->balance(tmp7,tmp8,tmp9,tmp12);
		}
	}
	HX_STACK_LINE(148)
	return tmp5;
...
Void BalancedTree_obj::iteratorLoop( ::haxe::ds::TreeNode node,cpp::ArrayBase acc){
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","iteratorLoop",0x3392c523,"haxe.ds.BalancedTree.iteratorLoop","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",153,0x9022da28)
		HX_STACK_THIS(this)
		HX_STACK_ARG(node,"node")
		...
		if ((tmp)){
			...
			HX_STACK_LINE(155)
			this->iteratorLoop(tmp1,acc);
			HX_STACK_LINE(156)
			Dynamic tmp2 = node->value;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(156)
			acc->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp2);
			HX_STACK_LINE(157)
			::haxe::ds::TreeNode tmp3 = node->right;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(157)
			this->iteratorLoop(tmp3,acc);
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("haxe.ds.BalancedTree","keysLoop",0x20d5eba9,"haxe.ds.BalancedTree.keysLoop","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",161,0x9022da28)
		HX_STACK_THIS(this)
		HX_STACK_ARG(node,"node")
		HX_STACK_ARG(acc,"acc")
		HX_STACK_LINE(162)
...
::haxe::ds::TreeNode BalancedTree_obj::merge( ::haxe::ds::TreeNode t1,::haxe::ds::TreeNode t2){
	...
	HX_STACK_ARG(t2,"t2")
	HX_STACK_LINE(170)
	bool tmp = (t1 == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(170)
	if ((tmp)){
		HX_STACK_LINE(170)
		::haxe::ds::TreeNode tmp1 = t2;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(170)
		return tmp1;
	}
	HX_STACK_LINE(171)
	bool tmp1 = (t2 == null());		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(171)
	if ((tmp1)){
		HX_STACK_LINE(171)
		::haxe::ds::TreeNode tmp2 = t1;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(171)
		return tmp2;
	}
	HX_STACK_LINE(172)
	::haxe::ds::TreeNode tmp2 = t2;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(172)
	::haxe::ds::TreeNode tmp3 = this->minBinding(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(172)
	::haxe::ds::TreeNode t = tmp3;		HX_STACK_VAR(t,"t");
	HX_STACK_LINE(173)
	::haxe::ds::TreeNode tmp4 = t1;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(173)
	Dynamic tmp5 = t->key;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(173)
	Dynamic tmp6 = t->value;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(173)
	::haxe::ds::TreeNode tmp7 = t2;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(173)
	::haxe::ds::TreeNode tmp8 = this->removeMinBinding(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(173)
	::haxe::ds::TreeNode tmp9 = this->balance(tmp4,tmp5,tmp6,tmp8);		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(173)
	return tmp9;
}
...
::haxe::ds::TreeNode BalancedTree_obj::minBinding( ::haxe::ds::TreeNode t){
	HX_STACK_FRAME("haxe.ds.BalancedTree","minBinding",0xd2237344,"haxe.ds.BalancedTree.minBinding","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",176,0x9022da28)
	HX_STACK_THIS(this)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(177)
	bool tmp = (t == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(177)
	::haxe::ds::TreeNode tmp1;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(177)
	if ((tmp)){
		HX_STACK_LINE(177)
		HX_STACK_DO_THROW(HX_HCSTRING("Not_found","\xb6","\x92","\xa5","\xea"));
		...
		HX_STACK_LINE(178)
		bool tmp2 = (t->left == null());		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(178)
		if ((tmp2)){
			HX_STACK_LINE(178)
			tmp1 = t;
			...
			HX_STACK_LINE(179)
			::haxe::ds::TreeNode tmp3 = t->left;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(179)
			tmp1 = this->minBinding(tmp3);
		}
	}
	HX_STACK_LINE(177)
	return tmp1;
...
::haxe::ds::TreeNode BalancedTree_obj::removeMinBinding( ::haxe::ds::TreeNode t){
	HX_STACK_FRAME("haxe.ds.BalancedTree","removeMinBinding",0xe82c3b68,"haxe.ds.BalancedTree.removeMinBinding","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",182,0x9022da28)
	HX_STACK_THIS(this)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(183)
	bool tmp = (t->left == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(183)
	::haxe::ds::TreeNode tmp1;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(183)
	if ((tmp)){
		...
		HX_STACK_LINE(184)
		::haxe::ds::TreeNode tmp2 = t->left;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(184)
		::haxe::ds::TreeNode tmp3 = this->removeMinBinding(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(184)
		Dynamic tmp4 = t->key;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(184)
		Dynamic tmp5 = t->value;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(184)
		::haxe::ds::TreeNode tmp6 = t->right;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(184)
		tmp1 = this->balance(tmp3,tmp4,tmp5,tmp6);
	}
	HX_STACK_LINE(183)
	return tmp1;
}
...
::String BalancedTree_obj::toString( ){
	HX_STACK_FRAME("haxe.ds.BalancedTree","toString",0x3e62fddd,"haxe.ds.BalancedTree.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",205,0x9022da28)
	HX_STACK_THIS(this)
	HX_STACK_LINE(206)
	::haxe::ds::TreeNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(206)
	...
	if ((tmp1)){
		HX_STACK_LINE(206)
		tmp2 = HX_HCSTRING("{}","\xa2","\x6b","\x00","\x00");
	}
	else{
		HX_STACK_LINE(206)
		::haxe::ds::TreeNode tmp3 = this->root;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(206)
		::String tmp4 = tmp3->toString();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(206)
		::String tmp5 = (HX_HCSTRING("{","\x7b","\x00","\x00","\x00") + tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(206)
		tmp2 = (tmp5 + HX_HCSTRING("}","\x7d","\x00","\x00","\x00"));
	}
	HX_STACK_LINE(206)
	return tmp2;
}
