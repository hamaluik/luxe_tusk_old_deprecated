...
::String IntMap_obj::toString( ){
	HX_STACK_FRAME("haxe.ds.IntMap","toString",0xf29c6496,"haxe.ds.IntMap.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",80,0x604d6034)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	::String tmp = ::__int_hash_to_string(this->h);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(81)
	return tmp;
}
